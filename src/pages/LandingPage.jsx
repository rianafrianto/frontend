...
const LandingPage = () => {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col">
            {/* Header */}
            <header className="bg-gray-200 shadow-lg py-5 px-10 flex justify-end items-center">
                <div>
                    <button
            ...
            <main className="flex-grow flex items-center justify-center bg-gradient-to-r from-blue-50 to-gray-50">
                <div className="text-center max-w-2xl">
                    <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-5">
                        Welcome to Our Resto
                    </h1>
                    <p className="text-lg md:text-xl text-gray-600 mb-8">
                    Explore our menu and indulge in delicious cuisines. Reserve your table or order now!
                    </p>
                    <div>
                        <button
